...
export const webPackage = [
    ...
    },
    {
        ...
        services: ['ออกแบบ Landing Page ที่สวยงามและตอบโจทย์ธุรกิจ', 'ออกแบบเว็บไซต์ 10 หน้า', 'ปรับขนาดให้เหมาะกับทุกอุปกรณ์', 'เชื่อมต่อ Social Media', 'เชื่อมต่อ Google Maps', 'SEO เบื้องต้น', 'มีระบบสมัครสามชิก', 'มีระบบหลังบ้าน', 'สามารถจัดการเนื้อหาหลังบ้าน', 'ระบบค้นหาข้อมูล'],
    ...
    },
    {
        ...
        services: ['ออกแบบ Landing Page ที่สวยงามและระบริหารจัดการหลังบ้านที่มีความซับซ้อน', 'จำนวนหน้าขึ้นอยู่กับขนาดของระบบ', 'ปรับขนาดให้เหมาะกับทุกอุปกรณ์', 'เชื่อมต่อ Social Media', 'เชื่อมต่อ Google Maps', 'SEO ขั้นสูง', 'มีระบบสมัครสามชิก', 'มีระบบหลังบ้าน', 'สามารถจัดการเนื้อหาหลังบ้าน', 'ระบบค้นหาข้อมูล', 'ระบบการชำระเงินผ่านธนาคาร', 'ตรวจสอบการชำระเงิน'],
