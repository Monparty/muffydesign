...
export default function Navbar() {
    ...
    return (
            <nav className={`flex ${show && 'hidden'} w-fit gap-5 my-5 mx-10 rounded-full bg-white/30 backdrop-blur-md border text-red-600 justify-between items-center py-2 px-2 fixed top-0 z-50`}>
                <Link href="/" className='text-2xl 2xl:text-3xl mr-10 flex items-center gap-4'>
