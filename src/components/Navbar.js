...
export default function Navbar() {
    ...
    return (
        <div>
                ...
                <div className="m-5 bg-white/30 backdrop-blur-md rounded-full">
                    ...
                    <div className="border rounded-full hidden lg:flex gap-5 p-2 w-fit justify-between items-center">
                        ...
                        <div className='flex gap-5 border-l pl-5'>
                            <Link href="https://line.me/ti/p/%40388rnahg" target="_blank" className="p-2 rounded-full bg-white hover:opacity-90">
                            ...
                            <Link href="https://web.facebook.com/profile.php?id=61555308387991" target="_blank" className="p-2 rounded-full bg-white hover:opacity-90">
            ...
            <div className='w-full h-0 fixed top-0 left-0 z-[22]'>
