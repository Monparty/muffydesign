    ...
    return (
        <div data-aos="fade-up" className="w-full grid gap-3">
            <div className="zoomImg rounded-xl">
                <Image src={img} className="w-full h-60 object-cover" />
            </div>
            <h2>{title}</h2>
            <p className="font-light text-sm break-all leading-5 h-16 text-ellipsis overflow-hidden text-gray-600">{detail}</p>
