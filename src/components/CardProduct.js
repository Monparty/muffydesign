...
export default function CardProduct({img, title, detail}) {
    ...
    return (
        <div data-aos="fade-up" className="w-full grid gap-4 text-xl">
            <div className="zoomImg rounded-xl">
                <Image src={img} alt="x" className="w-full h-60 object-cover" />
            </div>
            <h2 className="font-bold">{title}</h2>
            <p className="break-all text-base leading-5 h-16 text-ellipsis overflow-hidden text-gray-600">{detail}</p>
