export default function BoxFilter({filterDisplay}) {
    return (
        <div className={`${filterDisplay ? 'block' : 'hidden'} w-64 grid h-fit gap-2 sticky top-3 mb-3`}>
            ...
            <details data-aos="fade-up" className="border border-red-200 rounded-md">
                <summary className="flex 2xl:text-xl font-light cursor-pointer hover:bg-red-50 items-center py-2 px-2 focus:bg-red-200 rounded-md">
                    ตัวเลือก
                    <div className="ml-auto p-1 rounded-full bg-red-400">
                        <svg className="fill-current opacity-75 w-3 h-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path fill="#fff" d="M12.95 10.707l.707-.707L8 4.343 6.586 5.757 10.828 10l-4.242 4.243L8 15.657l4.95-4.95z"/></svg>
                    </div>
