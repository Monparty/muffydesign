...
export default function HeroSection() {
    return (
        <section className='w-full h-screen flex bg-gradient-to-r from-red-300 from-10% via-red-400 via-30% to-red-700 to-90%'>
            <div className='md:w-1/2 2xl:w-3/5 flex justify-center items-center mx-10'>
            ...
            <div className='md:w-1/2 2xl:w-2/5 flex flex-col justify-center items-center md:px-10 2xl:px-20 text-center text-red-500 gap-10'>
                <h1 className='text-2xl 2xl:text-4xl text-white'>
