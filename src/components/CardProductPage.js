...
export default function CardProductPage({ path, id, img, title, price, sold, filterDisplay }) {
    ...
    return (
        <Link href={`/${path}/${id}`} className={`${filterDisplay ? 'w-72 2xl:w-72' : 'w-96 2xl:w-[22rem]'}`}>
