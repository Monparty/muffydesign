...
export default function QuestionSection({question, answer}) {
  ...
  return (
    <details data-aos="fade-up" className="border border-red-200 rounded-md">
      <summary className="flex text-xl font-light py-4 cursor-pointer hover:bg-red-50 items-center px-4 focus:bg-red-200 rounded-md">
        {question}
      ...
      <div className="px-6 py-3 rounded-md text-lg">{answer}</div>
    </details>
  )
}