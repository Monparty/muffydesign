        ...
        <div className={`flex ${isOpen ? 'w-full' : 'w-0'} transition-all duration-200`}>
            <div ref={sidebarRef} className={`w-3/5 ${isOpen ? 'opacity-100' : 'opacity-0 hidden'} lg:hidden delay-100 flex flex-col h-dvh py-24 px-10 gap-3 bg-white border-r`}>
                ...
                <div className='flex gap-5 border-l pl-5'>
                    <Link href="https://line.me/ti/p/%40388rnahg" target="_blank" className="p-2 rounded-full bg-red-100 hover:opacity-90">
                    ...
                    <Link href="tel:0943030401" className="p-2 rounded-full bg-red-100 hover:opacity-90">
                    ...
                    <Link href="https://web.facebook.com/profile.php?id=61555308387991" target="_blank" className="p-2 rounded-full bg-red-100 hover:opacity-90">
