    ...
    return (
        <div className="grid gap-10">
            ...
            <div className='flex flex-wrap gap-5 justify-center'>
                <Link href="#" className='bg-red-600 font-bold text-white p-4 2xl:px-12 2xl:py-4 rounded-full flex gap-2 items-center hover:opacity-90 w-56'>
                    {icon1}
                    <span>
                        งานออกแบบของเรา
                    </span>
                </Link>
                <Link href="#" className='border-2 font-bold border-red-600 hover:bg-red-100 p-4 text-red-600 2xl:px-12 2xl:py-4 rounded-full flex gap-2 items-center w-56'>
                    {icon2}
                    <span>
                        งานออกพัฒนาเว็บไซต์
                    </span>
