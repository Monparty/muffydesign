...
export default function Page() {
    ...
    return (
        <div className='px-5 2xl:container 2xl:mx-auto'>
            <div className='bg-red-200 h-[26rem] w-full rounded-b-xl'>
                <h1 className="flex text-6xl justify-center items-center h-full">
                    Design
                </h1>
            </div>
            ...
            <section className='flex gap-3 h-full'>
                ...
                <div className="flex flex-wrap md:grid-cols-3 2xl:grid-cols-4 gap-3">
